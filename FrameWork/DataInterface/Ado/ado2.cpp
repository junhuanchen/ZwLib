...
// Version 2.20
//
// Self code may be used in compiled form in any way you desire. Self
...
//
// Self file is provided "as is" with no expressed or implied warranty.
...
#ifdef _DEBUG
    PutInfo( "%s:%d\n", ErrorStr.GetString( ), MB_OK | MB_ICONERROR );
#endif
...
BOOL CADORecordset::Open( _ConnectionPtr mpdb, LPCTSTR lpstrExec, int nOption )
{
    ...
    try
    {
        ...
        {
            PutInfo( "Unknown parameter. %d", nOption );
            return FALSE;
        }
    }
    catch ( _com_error &e )
...
BOOL CADORecordset::Find( LPCTSTR lpFind, int nSearchDirection )
{
    ...
    {
        PutInfo( "Unknown parameter. %d", nSearchDirection );
    ...
    try
    {
        ...
        switch ( vtVal.vt )
        {
            ...
            case VT_DECIMAL:
                ...
                dblVal /= pow( (float) 10, vtVal.decVal.scale );
                break;
            case VT_UI1:
                dblVal = vtVal.iVal;
                break;
